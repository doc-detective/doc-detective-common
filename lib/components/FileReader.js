...
var FileReader = function FileReader() {
  var _useState = (0, _react.useState)(''),
    ...
    fileContents = _useState2[0],
    setFileContents = _useState2[1];
  ...
  var readFile = function readFile() {
    if (isElectron) {
      ...
      fetch('/read-file').then(function (response) {
        return response.text();
      }).then(function (data) {
        return setFileContents(data);
      })["catch"](function (err) {
  ...
  }, "Read File"), /*#__PURE__*/_react["default"].createElement("pre", {
